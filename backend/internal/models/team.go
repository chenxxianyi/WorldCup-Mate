...
type Team struct {
	...
	ExternalProvider string         `gorm:"size:30;uniqueIndex:idx_team_external_identity" json:"external_provider"`
	ExternalID       *string        `gorm:"size:40;uniqueIndex:idx_team_external_identity" json:"external_id"`
