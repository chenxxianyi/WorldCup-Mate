...
async function submit() {
  ...
  try {
    ...
    const redirect = typeof route.query.redirect === 'string' && route.query.redirect.startsWith('/') ? route.query.redirect : '/profile'
    ...
    <section class="login-panel">
      ...
      <form class="login-form" @submit.prevent="submit">
        ...
        <div class="form-stack">
          ...
          <label class="field-label">密码<div class="field-control"><ThemeIcon name="lock" /><input v-model="password" type="password" autocomplete="current-password" required /></div></label>
