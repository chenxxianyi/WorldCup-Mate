  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'profile/favorite-teams', name: 'profile-favorite-teams', component: () => import('@/pages/user/FavoriteTeamsPage.vue') },
        { path: 'profile/favorite-matches', name: 'profile-favorite-matches', component: () => import('@/pages/user/FavoriteMatchesPage.vue') },
        { path: 'profile/reminders', name: 'profile-reminders', component: () => import('@/pages/user/MatchRemindersPage.vue') },
